...
import { getResolvedIssues } from "../api/issueApi";
...
const ResolvedIssues = () => {
  ...
  useEffect(() => {
    const fetchResolved = async () => {
      try {
        const res = await getResolvedIssues();
  ...
  if (loading) {
    return <p className="text-center mt-10 text-gray-700">Loading resolved issues...</p>;
  }
